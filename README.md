...
`bazi.py` 是一个用于 **八字排盘、五行分数统计、扶抑分类、单字逐字分析、整柱关系与大运滚动显示** 的命理工具。此工具简化自前辈[china-testing](https://github.com/china-testing/bazi)的八字分析工具，若需要更多解释判定，请访问 https://github.com/china-testing/bazi 
